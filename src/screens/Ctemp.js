...
<h2> Individual cards  </h2>
            ...
            <h3> Different color card for ucsd topcis: COLOR CODE IS C69214</h3>
            <a href="https://canvas.ucsd.edu/" style={{textDecoration: "none"}}><Card sx={{ maxWidth: 345 }} style={{borderRadius: '16px', color: "white", background:"#C69214", margin:"auto"}} > 
                <CardActionArea>
                    <CardMedia
                    style={{borderRadius: '10px',  margin: "auto"}}
                    component="img"
            ...
            <Card sx={{ maxWidth: 345 }} style={{borderRadius: '16px', color: "white", background:"#182B49", margin:"auto"}} > 
                <CardActionArea style ={{paddingRight:"30px"}}>
                    <CardMedia
                    style={{ borderRadius: '10px', marginLeft:"15px", marginTop:"15px"}}
                    component="img"
                    height="160"
                    //image="../images/reddit.jpeg"
                    img src={logo} 
